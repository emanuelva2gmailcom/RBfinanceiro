      ...
      <?php }else{ ?>
        ...
        <tr>
            ...
            <td class="actions">
              ...
              <?= $this->Form->postLink(__('Deletar'), ['controller' => 'Fluxocontas', 'action' => 'delete', $fluxocontas->id_fluxoconta], ['class'=>'btn btn-xs btn-outline-danger', 'confirm' => __('Are you sure you want to delete # {0}?', $fluxocontas->id_fluxoconta)]) ?>
            </td>
        </tr>
        <?php endforeach; ?>
      <?php } ?>
