...
class TipopagamentosFixture extends TestFixture
{
    ...
    // phpcs:disable
    public $fields = [
        'id_tipopagamento' => ['type' => 'integer', 'length' => 10, 'autoIncrement' => true, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'unsigned' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_tipopagamento'], 'length' => []],
        ],
    ];
    // phpcs:enable
    /**
