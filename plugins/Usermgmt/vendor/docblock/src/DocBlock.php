...
class DocBlock
{
    ...
    public function __construct($reflectorOrComment)
    {
		...
		$this->setAutoloadString();

		$this->parseDocBlock($reflectorOrComment);
    }

	public function setAutoloadString() {
		require_once(__DIR__.DS.'auto_load.php');

		$autoload = new AutoLoad();
		$this->autoloadstrig = $autoload->autoloadstrig();
	}
    ...
    protected function parseDocBlock($raw)
    {
		...
		require_once(__DIR__.DS.'DocParser.php');

		$docParser = new DocParser();
		$raw = $docParser->parse($this->autoloadstrig);
