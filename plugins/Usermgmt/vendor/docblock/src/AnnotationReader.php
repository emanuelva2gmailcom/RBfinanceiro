...
use DocBlock\Common\Annotations\Annotation\IgnoreAnnotation;
use DocBlock\Common\Annotations\Annotation\Target;
use ReflectionClass;
...
class AnnotationReader implements Reader
{
    ...
    private static $globalImports = [
        'ignoreannotation' => 'DocBlock\Common\Annotations\Annotation\IgnoreAnnotation',
    ];
